...
const ProfileInfo = () => (
  <div className="hidden xl:block xl:px-6 py-4">
    <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Sushmeeta S</h1>
    ...
    <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
      ...
      <p className="px-2 text-[15px]">sushmeetashailwi24@gmail.com</p>
    </div>
    <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <p className="px-2 text-[15px]">
        <a target="_blank" href="https://github.com/sushmeetaa" rel="noreferrer">
          gh/sushmeetaa
        </a>
      </p>
    </div>
